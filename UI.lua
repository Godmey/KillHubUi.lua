...
e.BackgroundColor3 = getgenv().Color["Primary"]
...
e.MouseButton1Down:connect(
    function()
        game.CoreGui.KiilHubUi.Main.Visible = not game.CoreGui.KiilHubUi.Main.Visible
    end
)
do
    if game:GetService("CoreGui"):FindFirstChild("KiilHubUi") then
        game:GetService("CoreGui").KiilHubUi:Destroy()
...
function a:Window(f, f, f)
    ...
    UiToggle_UiStroke1.Color = getgenv().Color["UiStroke"]
    ...
    j.Image = "rbxassetid://"..getgenv().Color["image"]
    ...
    function d:Tab(d, f)
        ...
        n.Name = d .. "Server"
        n.Text = ""
        n.BackgroundColor3 = getgenv().Color["Primary"]
        ...
        function a:Button(a, b)
            ...
            g.Name = "TextBtn"
            g.Parent = d
            g.BackgroundColor3 = getgenv().Color["Primary"]
        ...
        function a:Toggle(a, b, d)
            ...
            h.Name = "Button"
            h.Parent = f
            h.BackgroundColor3 = getgenv().Color["Primary"]
            ...
            o.Image = "rbxassetid://"..getgenv().Color["image"]
            j.Parent = h
        ...
        function a:Dropdown(a, b, d)
            ...
            f.Image = "rbxassetid://"..getgenv().Color["image"]
            k.Name = "DropTitle"
            k.Parent = g
            k.BackgroundColor3 = getgenv().Color["Primary"]
            k.BackgroundTransparency = 1
        ...
        function a:Slider(a, c, d, e, g)
            ...
            j.Parent = i
            j.BackgroundColor3 = getgenv().Color["Primary"]
            j.BackgroundTransparency = .1
            j.BorderSizePixel = 0
            ...
            l.Image = "rbxassetid://"..getgenv().Color["image"]
            m.Parent = j
        ...
        function a:Slider2(a, b, c, d, e)
            ...
            k.Image = "rbxassetid://"..getgenv().Color["image"]
            l.Parent = i
        ...
        function a:Seperator(a)
            ...
            b.Name = "Seperator"
            b.Parent = f
            b.BackgroundColor3 = getgenv().Color["Primary"]
            b.BackgroundTransparency = 1
            b.Size = UDim2.new(0, 379, 0, 30)
            c.Name = "Sep1"
            c.Parent = b
            c.BackgroundColor3 = getgenv().Color["Primary"]
            ...
            g.Color =
                ColorSequence.new {
                ColorSequenceKeypoint.new(0.00, getgenv().Color["Dark"]),
                ColorSequenceKeypoint.new(0.50, getgenv().Color["Primary"]),
                ColorSequenceKeypoint.new(1.00, getgenv().Color["Dark"])
            }
            g.Parent = c
            h.Color =
                ColorSequence.new {
        ...
        function a:Line()
            ...
            c.Color =
                ColorSequence.new {
                ColorSequenceKeypoint.new(0.00, getgenv().Color["Dark"]),
                ColorSequenceKeypoint.new(0.40, getgenv().Color["Primary"]),
                ColorSequenceKeypoint.new(0.50, getgenv().Color["Primary"]),
                ColorSequenceKeypoint.new(0.60, getgenv().Color["Primary"]),
                ColorSequenceKeypoint.new(1.00, getgenv().Color["Dark"])
            }
            c.Parent = b
        end
